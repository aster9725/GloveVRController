...
#define M_RES	1.4990234375f	// 10.0f * 4912.0f / 32760.0
#define A_RES	0.0001220703f	// 4.0f / 32768.0f
...
uint16_t AK8963_init(uint8_t Mmode, float* m_bias, float* m_scale);
uint16_t AK8963_init_slave(uint8_t Mmode);

uint8_t MPU9250_Calibrate(float* a_bias, float* g_bias);
uint8_t AK8963_Calibrate(float* m_bias, float* m_scale);
