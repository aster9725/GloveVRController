...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM GloveReport[] =
{
	...
	HID_RI_COLLECTION(8, 0x01), /* Application */
		...
		HID_RI_COLLECTION(8, 0x02), /* Logical */
			...
			HID_RI_LOGICAL_MINIMUM(32, 0x80000000),
			HID_RI_LOGICAL_MAXIMUM(32, 0x7FFFFFFF),
			HID_RI_REPORT_COUNT(8, 0x09),
			HID_RI_REPORT_SIZE(8, 0x20),
			HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
		HID_RI_END_COLLECTION(0),
		HID_RI_USAGE_PAGE(8, 0x09), /* Encoder 5 & Flex 5 (Usage Page Button) */
		HID_RI_USAGE_MINIMUM(8, 0x01),
		HID_RI_USAGE_MAXIMUM(8, 0x0A),
		HID_RI_LOGICAL_MINIMUM(8, 0x80),
		HID_RI_LOGICAL_MAXIMUM(8, 0x7f),
		HID_RI_REPORT_SIZE(8, 0x08),
		HID_RI_REPORT_COUNT(8, 0x0A),
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
	HID_RI_END_COLLECTION(0),
};
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"YS_Shim");
